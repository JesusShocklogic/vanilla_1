		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'label' => 'header\'s position',
					'name' => 'headers_position',
					'aria-label' => '',
					'type' => 'select',
					'instructions' => '',
					'required' => 0,
				...
				array(
					'key' => 'field_64765ce2f4ca3',
					'label' => 'Sub Menu items text colour',
					'name' => 'sub_menu_items_text_colour',
					'aria-label' => '',
					'type' => 'color_picker',
					'instructions' => 'This affects the menu items text except the active element',
					'required' => 0,
				...
				array(
					'key' => 'field_64765cf1f4ca4',
					'label' => 'Sub Menu items text colour (hover)',
					'name' => 'sub_menu_items_text_colour_hover',
					'aria-label' => '',
					'type' => 'color_picker',
					'instructions' => 'This affects the menu items text except the active element',
					'required' => 0,
					...
					'acfe_save_meta' => 0,
					'default_value' => '#1e2125',
					'enable_opacity' => 1,
					'return_format' => 'string',
				),
				array(
					'key' => 'field_6476606b7e511',
					'label' => 'Sub Menu items background colour',
					'name' => 'sub_menu_items_background_colour',
					'aria-label' => '',
					'type' => 'color_picker',
					'instructions' => 'This affects the menu items text except the active element',
					'required' => 0,
				...
				array(
					'key' => 'field_647660847e512',
					'label' => 'Sub Menu items background colour (hover)',
					'name' => 'sub_menu_items_background_colour_hover',
					'aria-label' => '',
					'type' => 'color_picker',
					'instructions' => 'This affects the menu items text except the active element',
					'required' => 0,
