<?php
wp_enqueue_style("modal-speakers-horizontal");
                    ...
                    <div class="modal-body modal_dialog_content_body ">
                        <div class="modal_dialog_content_body_left">
                            ...
                            <div class="modal_dialog_content_body_left_jobtitle">
                                <?= isset($speaker_wordpress_group['job_title']) ? $speaker_wordpress_group['job_title'] : ''; ?>
                            </div>
                            <div class="modal_dialog_content_body_left_companyname">
                                <?= isset($speaker_wordpress_group['company_organizarion']) ? $speaker_wordpress_group['company_organizarion'] : ''; ?>
                            </div>
                        </div>
